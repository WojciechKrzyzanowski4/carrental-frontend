...
function Offer({ offer, handleReservation }) {
  ...
  const isDateExcluded = (date) => {
    ...
    return reservedDates.some(
      (reserved) => reserved.reservationDate === dateString
    );
  };
          ...
          <>
            <div className="text-center mt-[20vh]">
              ...
              <h1 className="mb-4">
                ...
                {selectedDate ? selectedDate.toLocaleDateString() : ""} for{" "}
                {offer.name}
              </h1>
          ...
          <>
            <div className="mx-10">
              <div className="px-4 sm:px-0">
                <h3 className="mb-6 text-3xl md:text-5xl lg:text-6xl leading-tight font-bold tracking-tight">
                  Offer Information
                </h3>
                <form></form>
                <p className="mt-1 max-w-2xl text-sm leading-6 text-gray-500">
                  Details about the offer and the car.
                </p>
              </div>
              ...
              <div className="px-4 sm:px-0">
                ...
                <p className="mt-1 max-w-2xl text-sm leading-6 text-gray-500">
                  Please select the date you want your reservation to be on
                </p>
              </div>
            </div>
          </>
